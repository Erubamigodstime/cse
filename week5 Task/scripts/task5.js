...
switch (new Date().getDay()) {
    ...
    case 2:
      ...
      break;
    case 3:
        newVariable = "Wednesday";
      break;
    case 4:
        newVariable = "Thursday";
      break;
    case 5:
        newVariable = "Friday";
      break;
    case 6:
        newVariable = "Saturday";
...
document.querySelector('#message2').innerHTML = newVariable
/* FETCH */
...
const output = (temples) =>{
    temples.forEach(temple => {
        ...
        let temp = document.getElementById('temples')
...
function reset(){
    let art = document.getElementById('temples')
    art.innerHTML = '';
}
      ...
      output(
        templeList.sort((a, b) =>
          a.templeName.toLowerCase() > b.templeName.toLowerCase()
            ? 1
            : b.templeName.toLowerCase() >
              a.templeName.toLowerCase()
            ? -1
            : 0
        )
      );
...
const htmlSort = document.querySelector("#sortBy");
htmlSort.addEventListener("change", sortBy);
